...
# from solver.nonlinearity.Input import input_data, materials_data, coor_data, lines_data, polygons_data
# from solver.nonlinearity.temp import output

# input_data, materials_data, coor_data, lines_data, polygons_data
